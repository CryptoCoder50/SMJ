...
// const mnemonic = fs.readFileSync(".secret").toString().trim();
 const { mnemonic, snowtraceApiKey, bscApiKey, polygonApiKey } = require("./.env.json");
...
module.exports = {
  ...
  api_keys: {
    polygonscan: "4CJYAMGU1AHX87JSUAEBAGC4JTWE8SQNK1",
    bscscan: "JIQAFRQ7UITMTVB9AXTYFKB8P5RVZXNKK2",
    snowtrace: "4UCGD9I2UF9594BG98KNDBJPWK22SBKI52",
  },
